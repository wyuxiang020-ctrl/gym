...
export const EXERCISE_LIBRARY: ExerciseCategory[] = [
  { category: '胸', exercises: [...PUSH_COMPOUND, '绳索夹胸', '哑铃俯身飞鸟'] },
  { category: '背', exercises: [...PULL_COMPOUND, '直臂下拉'] },
  { category: '肩', exercises: ['站姿杠铃推举', '哑铃侧平举', '绳索面拉'] },
  { category: '手臂', exercises: ['哑铃弯举', '杠铃弯举', '哑铃锤式弯举', '绳索三头下压', '窄距卧推'] },
  { category: '腿', exercises: [...LEGS_COMPOUND, ...LEGS_ISOLATION] },
  { category: '核心', exercises: CORE },
]
